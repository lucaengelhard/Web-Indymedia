  ...
  tutorials.forEach((tutorial, i) => {
    ...
    if(tutorialFiltered.includes(tutorial.postid)){
      if(tutorial.image == ""){
        ...
        //Arikel Einbauen
        articleText.insertAdjacentHTML("beforeend", "<article id='"+tutorial.postid+"' class='post-text' title='"+tutorial.title+"'> <a class='article-link' href='"+tutorial.posturl+"'><div class='subtitle'><span class='post-author'>"+tutorial.author+"</span></div><h1>"+tutorial.title+"</h1><p>"+tutorial.shorttext+"</p></a><a class='morebutton' href='"+tutorial.posturl+"'><p>mehr &gt;&gt;</p></a></article>");
      } else {
        //console.log("image");

        //Artikel Einbauen
        if(columnSwitch == 0){
          columnLeft.insertAdjacentHTML("beforeend", "<article id='"+tutorial.postid+"' class='post-image' title='"+tutorial.title+"'> <a class='article-link' href='"+tutorial.posturl+"'><img src='"+tutorial.image+"'><div  class='subtitle'><span class='post-author'>"+tutorial.author+"</span></div><h1>"+tutorial.title+"</h1><p>"+tutorial.shorttext+"</p></a><a class='morebutton' href='"+tutorial.posturl+"'><p>mehr &gt;&gt;</p></a></article>");
          columnSwitch = 1;
        } else {
