...
document.querySelector(".torbutton").onclick = function (){
  torchecker();
...
function torchecker(){
  ...
  fetch("/ipcheck", options)
  .then(res => res.json())
  .then(response => {
    //console.log(response);

    //Fetch Tor Exit List
    var torarray = ["185.195.71.2",
           "109.70.100.28",
           "51.75.64.23",
           "82.221.128.191",
           "109.70.100.31",
       ...
       if(torarray.includes(response.ip)){
         //console.log("using Tor");
         torquestion = confirm("Willst du wirklich auf die TOR-Version von Indymedia wechseln?\nLink");
         //console.log(torquestion);
         if(torquestion){
           //go to onion Link
         }
       } else {
         alert("Um auf die .onion Version von Indymedia zu wechseln, brauchst du den TOR-Browser");
       }
